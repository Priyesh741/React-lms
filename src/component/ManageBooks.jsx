...
const ManageBooksPage = () => {
  ...
  const books = [
    { id: "Job-B0-01", title: "The Great Galaxy", author: "F. Scott Fitzgerald", status: "Available" },
    { id: "Job-B0-02", title: "The Star Mockingbird", author: "George Orwell", status: "Available" },
    { id: "Job-B0-03", title: "Present of the Caribbean", author: "John Austin", status: "Reserved" },
    { id: "Job-B0-04", title: "Pinks and Pinquicks", author: "J.G. Safinger", status: "Available" },
    { id: "Job-B0-05", title: "Journey to the Moon", author: "Arthur C. Clarke", status: "Damaged" },
    { id: "Job-B0-06", title: "The Dark Knight Rises", author: "Christopher Nolan", status: "Available" },
    { id: "Job-B0-07", title: "The Infinite War", author: "Frank Herbert", status: "Reserved" },
    { id: "Job-B0-08", title: "Science in the Stars", author: "Isaac Asimov", status: "Damaged" },
    { id: "Job-B0-09", title: "The Lost City", author: "Agatha Christie", status: "Available" },
    { id: "Job-B0-10", title: "The Silent Sea", author: "Jules Verne", status: "Reserved" },
    { id: "Job-B0-11", title: "Winds of Time", author: "H.G. Wells", status: "Damaged" },
    { id: "Job-B0-12", title: "The Final Countdown", author: "Ray Bradbury", status: "Available" },
    { id: "Job-B0-13", title: "Under the Red Sky", author: "Neil Gaiman", status: "Available" },
    { id: "Job-B0-14", title: "The Glass Castle", author: "Jeannette Walls", status: "Reserved" },
    { id: "Job-B0-15", title: "Echoes in the Void", author: "Douglas Adams", status: "Damaged" },
  ];
                ...
                {currentBooks.length > 0 ? (
                  currentBooks.map((book) => (
                    <tr key={book.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 font-medium text-gray-900">{book.id}</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        <div className="flex space-x-3">
                          <button className="px-4 py-2 rounded-full text-sm font-medium transition bg-green-100 text-green-700 hover:bg-blue-200">View</button>
                          <button className="px-4 py-2 rounded-full text-sm font-medium transition bg-blue-100 text-blue-700 hover:bg-blue-200">Edit</button>
                          <button className="px-4 py-2 rounded-full text-sm font-medium transition bg-red-100 text-red-700 hover:bg-red-200">Delete</button>
                        </div>
                      </td>
                    </tr>
                  ))
